...
# #### NOTA: I tried to use web scrapping in order to get data, but I attempt in 2 different web sites,and I highlighted that every few hours, position of data change location, doing not ppossible to fix data.
